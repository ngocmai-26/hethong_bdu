...
function KPICateDetail() {
  const { id } = useParams();
  const { allKpiCategories , singleKpiCategories} = useSelector((state) => state.kpiCategoriesReducer);
              ...
              <form action="#">
                <div className="grid grid-cols-6 gap-6">
                  <div className="col-span-6 sm:col-span-3">
                    ...
                    <span>{singleKpiCategories?.response?.name}</span>
                  </div>
                  <div className="col-span-6">
                    ...
                    <span className="text-sm">{singleKpiCategories?.response?.description}</span>
                  </div>
                </div>
